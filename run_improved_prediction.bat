@echo off
echo ==================================================
echo  UnSupervisedLearning 改进模型预测程序
echo ==================================================
echo.
...
if %errorlevel%==1 (
    echo 启动目录监控模式...
    python src/improved_realtime_predictor.py --mode monitor
) else if %errorlevel%==2 (
    echo 启动数据模拟模式...
    python src/improved_realtime_predictor.py --mode simulate
